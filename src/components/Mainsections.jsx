    ...
    return (
        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <div className="md:w-1/2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div className="rounded-xl overflow-hidden shadow-lg border-2 border-yellow-400">
                <img src={img1} alt="Cox's Bazar" className="w-full h-40 object-cover" />
                <div className="p-2 text-center font-semibold">COX’S BAZAR</div>
              </div>

              <div className="rounded-xl overflow-hidden shadow-lg">
                <img src={img2} alt="Sreemangal" className="w-full h-40 object-cover" />
                <div className="p-2 text-center font-semibold">SREEMANGAL</div>
              </div>

              <div className="rounded-xl overflow-hidden shadow-lg">
                <img src={img3} alt="Sundarbans" className="w-full h-40 object-cover" />
                <div className="p-2 text-center font-semibold">SUNDARBANS</div>
              </div>
            </div>
          </div>
    );
